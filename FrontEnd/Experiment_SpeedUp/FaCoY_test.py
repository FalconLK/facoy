...
hitlog_path = '/Users/Falcon/Desktop/Tracing/hit_logs_for_each_test.txt'
scorelog_path = '/Users/Falcon/Desktop/Tracing/Score_logs_test/'
base_path = '/Users/Falcon/Desktop/IJA/dataset/Experiment/'

def save_experiment_result(input, string):
    write_file(base_path + "New_Recommended_Set_test/" + str(input) + "_result.txt", string)
...
def run(name=None):
    ...
    targets = read_content_in_file(base_path + "targets_for_recommendation_test.txt")
